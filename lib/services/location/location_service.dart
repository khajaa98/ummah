...
// Hide geolocator's own LocationServiceDisabledException — we re-export our
// own typed version via app_exception.dart so the rest of the codebase
// pattern-matches a single class.
