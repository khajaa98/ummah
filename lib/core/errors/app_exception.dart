...
class ServerException extends NetworkException {
  ...
  /// Optional payload smuggled with the error — e.g. `checkin_count_today`
  /// on a 409 ALREADY_CHECKED_IN so the UI can update the displayed count
...
class ParseException extends AppException {
  const ParseException({
    ...
    String? hint,
          ...
          hint == null
              ? 'Failed to parse response (field: $field): $rawValue'
              : 'Failed to parse response (field: $field): $rawValue. $hint',
        );
